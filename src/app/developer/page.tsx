            ...
            <div className="container mx-auto flex flex-col md:flex-row items-center px-4 py-10">
                ...
                <div className="text-container flex-1 pl-0 md:pl-10 mt-6 md:mt-0">
                    <div className="flex mb-5 items-center">
                        <svg className="mr-2" xmlns="http://www.w3.org/2000/svg" width="40px" height="40px" viewBox="0 0 512 512">
                            <path fill="none" stroke="#c37f09" stroke-linecap="round" stroke-linejoin="round" stroke-width="32" d="M80 212v236a16 16 0 0 0 16 16h96V328a24 24 0 0 1 24-24h80a24 24 0 0 1 24 24v136h96a16 16 0 0 0 16-16V212"/>
                            <path fill="none" stroke="#c37f09" stroke-linecap="round" stroke-linejoin="round" stroke-width="51" d="M480 256L266.89 52c-5-5.28-16.69-5.34-21.78 0L32 256m368-77V64h-48v69"/>
                        </svg>
                        <h2 className="text-md text-custom-beige text-2xl">Welcome to Beauty</h2>
                    </div>
                    <h1 className="text-3xl text-white font-bold mt-2">The Building Realty</h1>
                    <h1 className="text-3xl text-white font-bold">& Services</h1>
                    <p className="text-white mt-5 text-xs leading-relaxed">
                We are a team of experienced professionals dedicated to providing you with the best
                possible real estate services. Our passion for real estate, combined with our expertise
                and knowledge of the market, enables us to deliver exceptional results for our clients.
                We pride ourselves on our customer service, and we strive to exceed your expectations
                every step of the way. We are available to answer any questions you may have and provide 
                you with the information you need to make informed decisions
                    </p>
                    <a href="#" className="inline-block mt-6 bg-yellow-500 text-white py-3 px-6 rounded-lg transition duration-300 hover:bg-yellow-400">
                        Get In Touch →
                    </a>
                </div>
            </div>
      ...
      <section className="bg-[#1a1a1a] w-full text-[#cfcfcf] py-16 text-center">
        ...
        <h2 className="text-[55px] text-3xl mb-4 text-white font-serif">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 items-center justify-center">
            {/* Team Member 1 */}
            <div className={`${style['team-item']} bg-[#1a1b1d] p-0 border border-gray-400`}>
              <img
